...
*/
        ...
        //a.gonzalez - Cálculo de cuanto dinero habría (como mínimo) para limitar el reward en base a la supply maxima
        CBlockIndex* newBlockIndex = new CBlockIndex();
        newBlockIndex->nHeight = pindexBest->nHeight +1;
        newBlockIndex->nMoneySupply = pindexBest->nMoneySupply + nFees;
