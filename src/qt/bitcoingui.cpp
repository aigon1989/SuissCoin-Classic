...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    spinnerFrame(0)
{
    setWindowTitle(tr("Swisscoin-Classic") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/swisscoin-classic"));
    setWindowIcon(QIcon(":icons/swisscoin-classic"));
#else
...
void BitcoinGUI::createActions(int nQtStyle) {
    ...
    sendCoinsAction->setToolTip(tr("Send coins to an Swisscoin-Classic address"));
    ...
    toggleHideAction = new QAction(QIcon(":/icons/swisscoin-classic"), tr("&Show / Hide"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/swisscoin-classic"), tr("&About Swisscoin-Classic"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/swisscoin-classic_testnet"));
            setWindowIcon(QIcon(":icons/swisscoin-classic_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/swisscoin-classic_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Swisscoin-Classic client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Swisscoin-Classic client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Swisscoin-Classic network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Swisscoin-Classic address or malformed URI parameters."));
    }
