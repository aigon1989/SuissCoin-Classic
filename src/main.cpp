...
bool CBlock::ConnectBlock(CBlockIndex* pindex, CCoinsViewCache &view) {
    ...
    if(IsProofOfWork() && (vtx[0].GetValueOut() > GetProofOfWorkReward(pindex, nFees)))
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Swisscoin-Classic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
void InitTestnet() {
    ...
    if(!fTestNet) return;
    //a.gonzalez - Cambiamos numeros mágicos
...
bool LoadBlockIndex(bool fAllowNew) {
    ...
    if(mapBlockIndex.empty()) {
        ...
        if(!fTestNet) {
            ...
            // The Swisscoin-Classic genesis block:
            ...
            //  Coinbase(hash=a95b9f457f, nTime=1504267100, ver=2, vin.size=1, vout.size=1, nLockTime=0, strTxComment=text:Swisscoin-Classic genesis block)
            ...
            const char* pszTimestamp = "Ciudadanos atrapa al PP mientras el PSOE se estanca y Podemos se hunde - La Vanguardia - 18/March/2018";
            txNew.vin.resize(1);
            txNew.vout.resize(1);
            txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(9999) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
            txNew.vout[0].nValue=100*COIN;
            txNew.vout[0].scriptPubKey = CScript() << ParseHex("0452634f87606c2d85425534661b62c290fab4e72a12066a29cc9bafdae64336630f7053cbfd3e9653d1fb010789645bd0e805b99e3b78e9810ec6f05ce5c0c6cc") << OP_CHECKSIG;
            txNew.nTime = 1504267100;
            txNew.strTxComment = "text:Swisscoin-Classic genesis block";
            block.vtx.push_back(txNew);
            block.hashPrevBlock = 0;
            block.hashMerkleRoot = block.BuildMerkleTree();
            block.nVersion = 1;
            block.nTime    = 1521383545;
            block.nBits    = bnProofOfWorkLimit.GetCompact();
            block.nNonce   = 200939;

        } else {

            // The Swisscoin-Classic testnet genesis block:
            ...
            txNew.strTxComment = "text:Swisscoin-Classic testnet genesis block";
            block.vtx.push_back(txNew);
            block.hashPrevBlock = 0;
            block.hashMerkleRoot = block.BuildMerkleTree();
            block.nVersion = 1;
            block.nTime    = 1521383563;
            block.nBits    = bnProofOfWorkLimit.GetCompact();
            block.nNonce   = 125929;
        ...
        if(!fTestNet) assert(block.hashMerkleRoot == uint256("0xf87458e7e7f0d8013fa40179c723b358552b7e25ad279049ce2fd1be57615eb2"));
        else assert(block.hashMerkleRoot == uint256("0x10429133a5ab8493bea4ed76630723bf726d5496fba33b65700cf8f0e308ab9c"));
...
//a.gonzalez - Cambiamos numeros magicos
unsigned char pchMessageStart[4] = { 0xfb, 0xfe, 0xbd, 0xfd };
