...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        AskPassphraseDialog->resize(598, 209);
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        stakingCheckBox->setToolTip(QApplication::translate("AskPassphraseDialog", "Disables outgoing payments and key import/export functions", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
